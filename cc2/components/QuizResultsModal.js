      ...
      <div className="space-y-3 max-h-96 overflow-y-auto">
        {sortedResults.length > 0 ? (
          sortedResults.map((result, index) => (
            <motion.div
              key={`${result.userId || "user"}_${result.studentId || index}`}
                ...
                <div className="flex-1">
                  <div className="flex items-center space-x-3">
                    <h4 className="font-medium text-gray-900 dark:text-white">
                      {String(result.studentName || "Unknown")}
                    </h4>
                    <span className="text-sm text-gray-500 dark:text-gray-400">
                      ({String(result.studentId || "N/A")})
                    </span>
                    <span
                    ...
                    >
                      {String(result.grade || "N/A")}
                    </span>
                  </div>
                  <div className="flex items-center space-x-4 mt-1 text-sm text-gray-600 dark:text-gray-400">
                    <span>
                      {result.score || 0}/{result.totalQuestions || 0} correct
                    </span>
                    <span>{result.percentage || 0}%</span>
                    <span>{formatTime(result.timeSpent || 0)}</span>
                  </div>
                </div>
    ...
    return (
      <div className="space-y-6">
        ...
        <div className="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <div>
              ...
              <p
                className={`font-bold text-xl ${getGradeColor(
        ...
        <div className="space-y-4 max-h-96 overflow-y-auto">
          {selectedSubmission.detailedResults &&
          Array.isArray(selectedSubmission.detailedResults) ? (
              ...
              >
                <div className="flex justify-between items-start mb-2">
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <span className="text-sm text-gray-500 dark:text-gray-400">
                      {result.points || 0}/{result.maxPoints || 1} pts
                    </span>
                  </div>
                </div>

                <p className="text-gray-700 dark:text-gray-300 mb-3">
                  {String(result.question || "Question not available")}
                </p>
                ...
                <div className="space-y-2 text-sm">
                  <div>
                    ...
                    >
                      {String(result.studentAnswer || "No answer")}
                    </span>
                  </div>
