...
export default function TrendingSection({ type = "all", limit = 5 }) {
    ...
    return (
      <div className="flex space-x-4 overflow-hidden">
        {[...Array(3)].map((_, i) => (
          <div
            key={i}
            className="flex-shrink-0 w-72 h-32 bg-gray-200 dark:bg-gray-700 rounded-lg animate-pulse"
          />
        ))}
      </div>
    );
  ...
  const cardClass =
    "flex-shrink-0 w-72 p-4 rounded-lg bg-white dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-750 cursor-pointer transition-colors border border-gray-200 dark:border-gray-700";
  ...
  return (
    <div className="overflow-x-auto">
      <div className="flex space-x-4 pb-4">
        ...
        {(trending.resources || []).map((resource) => (
          <div
            key={resource._id}
        ...
        {/* Popular Communities */}
        {(trending.communities || []).map((community) => (
          <div
            key={community._id}
