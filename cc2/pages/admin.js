...
export default function AdminPage() {
  ...
  const [pendingApprovals, setPendingApprovals] = useState({ jobs: [], events: [], total: 0 });
  ...
  const handleDeleteCommunity = async (communityId) => {
    if (!confirm('Are you sure you want to delete this community? This will delete all posts and cannot be undone.')) {
      return;
    }
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6">
            ...
            {isAdmin && (
              ...
              >
                ...
                <h3 className="text-2xl font-bold mb-2 relative z-10">Pending</h3>
                <p className="text-orange-100 mb-4 relative z-10">Awaiting approval</p>
                <div className="flex items-center justify-between relative z-10">
                  <span className="text-3xl font-black">{pendingApprovals.total || 0}</span>
                  {pendingApprovals.total > 0 && (
                    <span className="text-sm bg-white/20 px-3 py-1 rounded-full animate-pulse">Review</span>
                  )}
                </div>
              </motion.button>
            )}
            ...
            >
              ...
              <p className="text-blue-100 mb-4 relative z-10">Manage campus events</p>
              <div className="flex items-center justify-between relative z-10">
                <span className="text-3xl font-black">{events.length}</span>
                <span className="text-sm bg-white/20 px-3 py-1 rounded-full">View All</span>
              </div>
            </motion.button>
            ...
            >
              ...
              <p className="text-green-100 mb-4 relative z-10">Manage job postings</p>
              <div className="flex items-center justify-between relative z-10">
            ...
            >
              ...
              <p className="text-purple-100 mb-4 relative z-10">Manage user accounts</p>
              <div className="flex items-center justify-between relative z-10">
            ...
            >
              ...
              <h3 className="text-2xl font-bold mb-2 relative z-10">Communities</h3>
              <p className="text-indigo-100 mb-4 relative z-10">Manage communities</p>
              <div className="flex items-center justify-between relative z-10">
                <span className="text-3xl font-black">{communities.length}</span>
                <span className="text-sm bg-white/20 px-3 py-1 rounded-full">View All</span>
              </div>
            </motion.button>
          </div>
                ...
                <div className="space-y-3 max-h-96 overflow-y-auto">
                  ...
                  {filteredEvents.length === 0 && (
                    <div className="text-center py-12 text-gray-500 dark:text-gray-400">
                      {eventSearch ? '🔍 No events found matching your search' : '📭 No events yet'}
                    </div>
                  )}
                </div>
              </div>
              ...
              <div className="p-6">
                ...
                <div className="space-y-3 max-h-96 overflow-y-auto">
                  ...
                  {filteredJobs.length === 0 && (
                    <div className="text-center py-12 text-gray-500 dark:text-gray-400">
                      {jobSearch ? '🔍 No jobs found matching your search' : '📭 No jobs yet'}
                    </div>
                  )}
                </div>
              </div>
            ...
            >
              ...
              <div className="bg-gradient-to-r from-indigo-500 to-blue-500 p-6 flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <h2 className="text-2xl font-bold text-white">Manage Communities</h2>
                </div>
                <button
                  onClick={() => setShowCommunitiesModal(false)}
                  className="text-white hover:bg-white/20 p-2 rounded-lg transition-colors"
              ...
              <div className="p-6">
                ...
                <div className="space-y-3 max-h-96 overflow-y-auto">
                  ...
                  {filteredCommunities.length === 0 && (
                    <div className="text-center py-12 text-gray-500 dark:text-gray-400">
                      {communitySearch ? '🔍 No communities found matching your search' : '📭 No communities yet'}
                    </div>
                  )}
                </div>
              </div>
              ...
              <div className="bg-gradient-to-r from-orange-500 to-red-500 p-6 flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-orange-100 text-sm">{pendingApprovals.total || 0} items awaiting review</p>
                  </div>
                </div>
                <button
                  onClick={() => setShowPendingModal(false)}
                              ...
                              <div className="flex items-start justify-between">
                                <div className="flex-1">
                                  ...
                                  <div className="flex items-center gap-4 text-sm text-gray-500 dark:text-gray-400">
                                    ...
                                    <span>👤 {event.submittedBy?.name || 'Unknown'}</span>
                                  </div>
                                </div>
                              ...
                              <div className="flex items-start justify-between">
                                <div className="flex-1">
                                  ...
                                  <div className="flex items-center gap-4 text-sm text-gray-500 dark:text-gray-400">
                                    ...
                                    <span>👤 {job.submittedBy?.name || 'Unknown'}</span>
                                  </div>
                                </div>
                                <div className="flex gap-2 ml-4">
                                  <button
