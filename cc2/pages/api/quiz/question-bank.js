...
export default async function handler(req, res) {
  ...
  if (req.method === "GET") {
    try {
      ...
      // Get statistics
      const stats = {
        total: await questionBank.countDocuments({
          userId: new ObjectId(userId),
        }),
        byCategory: {},
        byDifficulty: {
          easy: await questionBank.countDocuments({
            userId: new ObjectId(userId),
            difficulty: "easy",
          }),
          medium: await questionBank.countDocuments({
            userId: new ObjectId(userId),
            difficulty: "medium",
          }),
          hard: await questionBank.countDocuments({
            userId: new ObjectId(userId),
            difficulty: "hard",
          }),
        },
