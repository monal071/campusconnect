  ...
  try {
    ...
    if (req.method === "PUT") {
      ...
      if (action === "accept") {
        ...
        try {
          await db.collection("userActivity").insertMany([
            {
              userId: request.senderId,
              type: "connection_accepted",
              content: `You are now connected with ${request.receiverId}`,
            ...
            },
            {
              ...
              type: "connection_accepted",
              content: `You are now connected with ${request.senderId}`,
          ...
          console.error("Failed to record connection activity:", err);
        }
